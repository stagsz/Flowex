...
**Last Updated:** 2026-01-25 (Add project-level member permissions - PM-05)
**Status:** In Progress
...
- Projects: Added project-level member permissions (PM-05) - `392a47d`
  ...
  - Frontend UI for member management can be added in future iteration
  - Completes PM-05 from project-dashboard.md spec
